    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                <div class="contentbg">
				    <div class="post">
                    <h2 class="class" align="center">Historico de Manutenção de Peças</h2>
					    <div class="entry">
					        <?php
                            // echo '<pre>';
                            // var_dump($_SESSION);
                            // echo '</pre>';
                                if(isset($_SESSION['listaManutencoes'])){
							        include '../Modelo/ModCadManutencaoPecas.php';
							        $lista = array();
                                    $lista = unserialize($_SESSION['listaManutencoes']);
                            ?>
                            <div>
                                <h3>Cadastrar Nova Peça</h3>
                                <a href="../Interface/IntCadManutencaoPecas.php">
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($lista as $p){
                                                ...
                                                echo '<td>'.$p->id_manutencao_pecas.'</td>';
                                                echo '<td>'.$p->qtd_utilizada.'</td>';
                                                echo '<td>'.$p->data_criacao.'</td>';
                                                echo '<td>
                                                        <a href="../Controle/CadManutencaoPecas.php?op=buscaAlterar&id='.$p->id_manutencao_pecas.'">
                                                        <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>';
                                                echo '<td>
                                                        <a href="../Controle/CadManutencaoPecas.php?op=deletar&id='.$p->id_manutencao_pecas.'">
                            ...
                            <?php
								    ...
								    header('location:../Controle/CadManutencaoPecas.php?op=buscarManutencoes');	
							    }					
					        ?>
                        </div>
	                </div>
