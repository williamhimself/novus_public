    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                <div class="contentbg">
				    <div class="post">
                    <h2 class="class" align="center">Historico de Peças</h2>
					    <div class="entry">
					        <?php
                            // echo '<pre>';
                            // var_dump($_SESSION);
                            // echo '</pre>';
                                if(isset($_SESSION['listaMaquinasPecas'])){
							        include '../Modelo/ModCadMaquinasPecas.php';
							        $lista = array();
                                    $lista = unserialize($_SESSION['listaMaquinasPecas']);
                            ?>
                            <div>
                                <h3>Cadastrar Novo Peça</h3>
                                <a href="../Interface/IntCadMaquinasPecas.php">
                            ...
                            <div class="container">
                                <table id="tableCons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>id maquinas pecas</th>
                                            <th>Quantidade minimo</th>
                                            <th>Data criacao</th>
                                            <th>Editar</th>
                                            <th>Excluir</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($lista as $p){
                                                ...
                                                echo '<td>'.$p->id_maquinas_pecas.'</td>';
                                                echo '<td>'.$p->qtd_minimo.'</td>';
                                                echo '<td>'.$p->data_criacao.'</td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquinasPecas.php?op=buscaAlterar&id='.$p->id_maquinas_pecas.'">
                                                        <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquinasPecas.php?op=deletar&id='.$p->id_maquinas_pecas.'">
                            ...
                            <?php
								    ...
								    header('location:../Controle/CadMaquinasPecas.php?op=buscarMaquinasPecas');	
							    }					
					        ?>
                        </div>
	                </div>
