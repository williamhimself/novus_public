        ...
        <div id="page-content-wrapper">
            ...
            <div id="content" class="container">
                ...
                <div class="son-form card">
                    <form name="cadMaquinaContato" id="cadMaquinaContato" enctype="multipart/form-data" action = "<?php echo '../Controle/cadMaquinaContato.php?op=cadastrar';?>" method="post">    
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nome" id="nome" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <div class="form-group">
                                <label for="">E-mail</label>
                                <input type="text" name="email" id="email" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <div class="form-group">
                                <label for="">Telefone</label>
                                <input type="text" name="telefone" id="telefone" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <div class="form-group">
                                <label for="">Informações Adicionais</label>
                                <textarea name="info_adicionais" id="info_adicionais" cols="30" rows="18" class="form-field form-control son-form-field" required></textarea>
                            </div>
                            <?php
						        }else{
                                    header('location:../Controle/CadMaquinaContato.php?op=consultar');
							    }					
                            ?>
                            <hr>
                        </div>
                        <div class="card-footer">
                            <div class="confirm-btns">
                                <button name="btncadastrar" id="btncadastrar" value="Cadastrar" class="btn btn-primary">Cadastrar</button>
                            </div>
                        </div>
                    </form>
                </div>
