            ...
            <div id="content" class="container">
                ...
                <div class="son-form card">
                   			<?php
                                ...
                                $listaHistoricos = unserialize($_SESSION['listaHistoricos']);
                       		?>
					<form name="cadHistoricoManutencao" id="cadHistoricoManutencao" enctype="multipart/form-data" action="../controle/cadHistoricoManutencao.php?op=alterar&id=<?php echo $listaHistoricos[0]->id_historico_manutencao;?>" method="post">
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipo" id="tipo" class="form-field son-form-field form-control">
                                    <?php 
                                        if($listaHistoricos[0]->tipo == 'p'){
                                            echo '<option value="p" selected >Manutenção Preventiva</option>';
                                            echo '<option value="c">Manutenção Corretiva</option>';
                                        }else{
                                            echo '<option value="p">Manutenção Preventiva</option>';
                                            echo '<option value="c" selected >Manutenção Corretiva</option>';
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="data_realizacao_manutencao" id="data_realizacao_manutencao" cols="30" rows="18" class="form-field form-control son-form-field" value="<?php echo date('Y-m-d',strtotime($listaHistoricos[0]->data_realizacao_manutencao));?>"required>
                            </div>
                            <div class="form-group">
                                <label for="">Titulo</label>
                                <input type="text" name="titulo" id="titulo" cols="30" rows="18" class="form-field form-control son-form-field" value="<?php echo $listaHistoricos[0]->titulo;?>" required placeholder="Digite no máximo 50 caracteres" maxlength = "50">
                            </div>
                            <div class="form-group">
                                <label for="">Descrição da Manutenção</label>
                                <textarea name="descricao" id="descricao" cols="30" rows="18" class="form-field form-control son-form-field" required><?php echo $listaHistoricos[0]->descricao;?></textarea>
                            </div>
                            <hr>
                        </div>
