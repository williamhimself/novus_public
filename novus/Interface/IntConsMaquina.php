    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                <div class="contentbg">
				    <div class="post">
                    <h2 class="class" align="center">Maquina</h2>
					    <div class="entry">
					        <?php
                            // echo '<pre>';
                            ...
                            ?>
                            <h3>Cadastrar Novo Maquina</h3>
                            <a href="../Interface/IntCadMaquina.php">
                            ...
                            <div class="container">
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($lista as $p){
                                                ...
                                                echo '<td>'.$p->id_maquina.'</td>';
                                                echo '<td>'.$p->descricao.'</td>';
                                                echo '<td>'.$p->patrimonio.'</td>';
                                                echo '<td>'.$p->email_aviso_manutencao.'</td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquina.php?op=buscaAlterar&id='.$p->id_maquina.'">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquina.php?op=deletar&id='.$p->id_maquina.'">
                                ...
                                <?php
                                        ...
                                        header('location:../Controle/CadMaquina.php?op=consultar');	
                                    }					
                                ?>
                            </div>
                        </div>
