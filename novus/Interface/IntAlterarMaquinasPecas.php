        ...
        <div id="page-content-wrapper">
            ...
            <div id="content" class="container">
                ...
                <div class="son-form card">
                    <form name="cadMaaquinasPecas" id="cadMaaquinasPecas" enctype="multipart/form-data" action = "../Controle/cadMaquinasPecas.php?op=alterar&id=<?php echo $lista[0]->id_maquinas_pecas;?>" method="post">    
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="qtd_minimo" id="qtd_minimo" cols="30" rows="18" class="form-field form-control son-form-field" value="<?php echo $lista[0]->qtd_minimo;?>" required>
                            </div>
                            <hr>
                        </div>
