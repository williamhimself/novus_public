    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                <div class="contentbg">
				    <div class="post">
                        <h2 class="class" align="center">Historico de Manutenção</h2>
					    <div class="entry">
					        <?php
                            // echo '<pre>';
                            // var_dump($_SESSION);exit;
                            // echo '</pre>';
                                if(isset($_SESSION['listaHistoricos'])){
							        include '../Modelo/ModCadHistoricoManutencao.php';
							        $lista = array();
                                    $lista = unserialize($_SESSION['listaHistoricos']);
                            ?>
                            <div>
                                <h3>Cadastrar Novo Manutenção</h3>
                                <a href="../Interface/IntCadHistoricoManutencao.php">
                                ...
                                <table id="tableCons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>id historico</th>
                                            <th>titulo</th>
                                            <th>data realização manutenção</th>
                                            <th>Editar</th>
                                            <th>Excluir</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($lista as $p){
                                                ...
                                                echo '<td>'.$p->id_historico_manutencao.'</td>';
                                                echo '<td>'.$p->titulo.'</td>';
                                                echo '<td>'.$p->data_realizacao_manutencao.'</td>';
                                                echo '<td>
                                                        <a href="../Controle/CadHistoricoManutencao.php?op=buscaAlterar&id='.$p->id_historico_manutencao.'">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>';
                                                echo '<td>
                                                        <a href="../Controle/CadHistoricoManutencao.php?op=deletar&id='.$p->id_historico_manutencao.'">
                            ...
                            <?php
								    ...
								    header('location:../Controle/CadHistoricoManutencao.php?op=buscarHistoricos');	
							    }					
					        ?>
                        </div>
	                </div>
