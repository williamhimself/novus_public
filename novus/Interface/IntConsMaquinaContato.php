    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                <div class="contentbg">
				    <div class="post">
                    <h2 class="class" align="center">Contato</h2>
					    <div class="entry">
					        <?php
                            // echo '<pre>';
                            // var_dump($_SESSION);
                            // echo '</pre>';
                                if(isset($_SESSION['listaMaquinaContato'])){
                            ...
                            <div>
                                ...
                                <a href="../Interface/IntCadMaquinaContato.php">
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($lista as $p){
                                                ...
                                                echo '<td>'.$p->descricaoMaquina.'</td>';
                                                echo '<td>'.$p->nome.'</td>';
                                                echo '<td>'.$p->email.'</td>';
                                                echo '<td>'.$p->telefone.'</td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquinaContato.php?op=buscaAlterar&id='.$p->id_contato.'">
                                                        <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>';
                                                echo '<td>
                                                        <a href="../Controle/CadMaquinaContato.php?op=deletar&id='.$p->id_contato.'">
                            ...
                            <?php
								    ...
								    header('location:../Controle/CadMaquinaContato.php?op=buscarMaquinaContato');	
							    }					
					        ?>
                        </div>
	                </div>
