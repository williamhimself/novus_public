    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content" class="container">
                <h3 id="main-page-form-title">Manutenção de Peças</h3>
                <?php
                    if(isset($_SESSION['listaManutencao'])){        
                        include '../Modelo/ModCadManutencaoPecas.php';
                        $lista = array();
                        $lista2 = array();
                        $lista = unserialize($_SESSION['listaManutencao'][0]);
                        $lista2 = unserialize($_SESSION['listaManutencao'][1]);
                ?>
                <div class="son-form card">
                    <form name="cadManutencaoPecas" id="cadManutencaoPecas" enctype="multipart/form-data" action = "<?php echo '../Controle/cadManutencaoPecas.php?op=cadastrar';?>" method="post">    
                        <div class="card-body">
                            <div class="form-group">
                                <label for="">Manuteção</label>
                                <select id="id_historico_manutencao" name="id_historico_manutencao" class="form-field son-form-field form-control" placeholder="Historicos Disponiveis">
                                    <?php
                                        foreach($lista as $p){
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="qtd_utilizada" id="qtd_utilizada" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <?php
						        }else{
                                    header('location:../Controle/CadManutencaoPecas.php?op=consultar');
							    }					
                            ?>
                            <hr>
                        </div>
