    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content" class="container">
                <h3 id="main-page-form-title">Maquinas de Peças</h3>
                <?php
                    if(isset($_SESSION['listaMaquinas'])){        
                        include '../Modelo/ModCadMaquinasPecas.php';
                        $lista = array();
                        $lista2 = array();
                        $lista = unserialize($_SESSION['listaMaquinas'][0]);
                        $lista2 = unserialize($_SESSION['listaMaquinas'][1]);
                ?>
                <div class="son-form card">
                    <form name="cadMaaquinasPecas" id="cadMaaquinasPecas" enctype="multipart/form-data" action = "<?php echo '../Controle/cadMaquinasPecas.php?op=cadastrar';?>" method="post">    
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="qtd_minimo" id="qtd_minimo" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <?php
						        }else{
                                    header('location:../Controle/CadMaquinasPecas.php?op=consultar');
							    }					
                            ?>
                            <hr>
                        </div>
