        ...
        <div id="page-content-wrapper">
            ...
            <div id="content" class="container">
                ...
                <div class="son-form card">
                    <form name="cadPeca" id="cadPeca" enctype="multipart/form-data" action = "<?php echo '../Controle/cadPeca.php?op=cadastrar';?>" method="post">
                            <div class="form-group">
                                <label for="">Descrição da Peça</label>
                                <input type="text" name="descricao" id="descricao" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                            <div class="form-group">
                                <label for="">Quantidade em Estoque</label>
                                <input type="number" name="qtd_estoque" id="qtd_estoque" cols="30" rows="18" class="form-field form-control son-form-field" required>
                            </div>
                        
                            <?php
						        }else{
                                    header('location:../Controle/CadPeca.php?op=consultar');
							    }					
                            ?>
                            <hr>
                        </div>
                        <div class="card-footer">
                            <div class="confirm-btns">
                                <button name="btncadastrar" id="btncadastrar" value="Cadastrar" class="btn btn-primary">Cadastrar Peça</button>
                            </div>
                        </div>
                    </form>
                </div>
